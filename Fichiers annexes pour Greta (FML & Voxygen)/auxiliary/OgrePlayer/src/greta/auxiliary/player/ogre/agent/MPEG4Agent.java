        ...
        Ogre.callSync(new greta.auxiliary.player.ogre.OgreThread.Callback() {public void run() {
            synchronized (MPEG4Agent.this) {
                if (mpeg4 != null) {
                    ...
                    bf.setDegreeValue(BAPType.l_hip_flexion, -90);
                    bf.setDegreeValue(BAPType.r_hip_flexion, -90);
                    bf.setDegreeValue(BAPType.l_knee_flexion, 90);
                    bf.setDegreeValue(BAPType.r_knee_flexion, 90);
