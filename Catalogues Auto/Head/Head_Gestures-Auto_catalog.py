'''
    ...
    Permet de faire un état des lieux des HeadGestures disponibles
    
    Entrée : fichier .xml d'un lexique de gestes issus de
        /BehaviorRealizer/BehaviorLexicon/HeadGestures.xml
    Sorties : 
...
file_in = open("../../../../greta-master/bin/BehaviorRealizer/BehaviorLexicon/HeadGestures.xml", "r", encoding="utf-8")
...
regex = re.compile(r"<(\w+) id=\"(\w+)\" lexeme=\"(\w+)\">")
...
file_html = open("Head_Gestures-List.html", "w", encoding="utf-8")
...
file_out = open("Head_Gestures-Planner.xml", "w", encoding="utf-8")
...
for classe in gestes :
    ...
    for categorie in gestes[classe] :
        ...
        #                   (/!\ réécrit à chaque lancement)
        file_FML = open("Head_Gestures-FMLs/FML_"+categorie+".xml", "w",
                                        encoding="utf-8")
