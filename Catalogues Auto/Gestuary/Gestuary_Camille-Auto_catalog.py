'''
    ...
    Entrée : fichier .xml d'un lexique de gestes issus de
        /BehaviorRealizer/BehaviorLexicon/gestuary_camille.xml
    Sorties : 
...
file_in = open("../../../../greta-master/bin/BehaviorRealizer/BehaviorLexicon/gestuary_camille.xml", "r", encoding="utf-8")
...
regex = re.compile(r"<([a-zA-Z]+) category=\"([a-zA-Z]+)\" id=\"([\w_]+)\">")
...
file_html = open("Gestuary_Camille-List.html", "w", encoding="utf-8")
...
file_out = open("Gestuary_Camille-Planner.xml", "w", encoding="utf-8")
...
for classe in gestes :
    ...
    for categorie in gestes[classe] :
        ...
        #                   (/!\ réécrit à chaque lancement)
        file_FML = open("Gestuary_Camille-FMLs/FML_"+categorie+".xml", "w",
                                        encoding="utf-8")
