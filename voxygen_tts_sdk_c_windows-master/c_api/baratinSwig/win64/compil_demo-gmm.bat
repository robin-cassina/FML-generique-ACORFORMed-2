...
set JDK_VERSION=1.8.0_191
set JDK_PATH=C:\Program Files\Java\jdk%JDK_VERSION%
echo.
...
rem  (!) don't use ""
rem set VCVAR_PATH=C:\Program Files (x86)\Microsoft Visual Studio\VC
set VCVAR_PATH=C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\VC\Auxiliary\Build
echo.
echo [0b] Set VisualStudio 64 bits environment
...
LINK /DLL baratinSwig.obj baratinSwig_wrap.obj /LIBPATH:..\..\..\bin\win64 libbaratinoo.lib /OPT:REF /OPT:ICF /nologo /machine:X64 /pdb:none

echo.
echo [1c] Copy baratinSwig.dll in ..\java-swig\Common\Lib\External\Voxygen\Win64\ directory like libbaratinoo.{dll,lib}
if not exist ..\java-swig\Common\Lib\External\Voxygen\Win64\NUL (
        echo "Create ..\java-swig\Common\Lib\External\Voxygen\Win64\, and copying libbaratinoo.dll"
        mkdir ..\java-swig\Common\Lib\External\Voxygen\Win64\
        COPY /Y ..\..\..\bin\win64\libbaratinoo.dll ..\java-swig\Common\Lib\External\Voxygen\Win64\
)
COPY /Y baratinSwig.dll ..\java-swig\Common\Lib\External\Voxygen\Win64\

echo.
echo [1d] Move baratinSwig.{dll,lib} in bin\win64\ directory like libbaratinoo.{dll,lib}
MOVE /Y baratinSwig.dll ..\..\..\bin\win64\
MOVE /Y baratinSwig.lib ..\..\..\bin\win64\
...
rem   /machine:x64 => Specify Target Platform
rem   /pbd:none	(? don't create Use Program Database, see https://msdn.microsoft.com/en-us/library/kwx19e36.aspx)
LINK /OUT:runBaratinSwig.exe runBaratinSwig.obj /LIBPATH:..\..\..\bin\win64 baratinSwig.lib libbaratinoo.lib /OPT:REF /OPT:ICF /MANIFEST /nologo /machine:X64 /pdb:none Ws2_32.lib Iphlpapi.lib Setupapi.lib
...
echo.
echo [2d] Move runBaratinSwig.exe in bin\win64\ directory to get the right configuration path and DLL path
MOVE /Y runBaratinSwig.exe ..\..\..\bin\win64\
