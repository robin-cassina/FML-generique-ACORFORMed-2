...
LINK /OUT:barademo_CPP.exe barademo_CPP.obj ..\..\..\bin\win64_debug\libbaratinoo.lib /DEBUG /MANIFEST /nologo /machine:X64 /pdb:none Ws2_32.lib Iphlpapi.lib Setupapi.lib

mt.exe -manifest barademo_CPP.exe.manifest -outputresource:barademo_CPP.exe

echo Move barademo_CPP.exe in bin\win64_debug\ directory to get the right configuration path and DLL path
move barademo_CPP.exe ..\..\..\bin\win64_debug\
copy ..\barademo_CPP.txt ..\..\..\bin\win64_debug\texte.txt
