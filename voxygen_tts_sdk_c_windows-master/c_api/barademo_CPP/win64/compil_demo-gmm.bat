...
echo.
echo [2] Linking ...
LINK /OUT:barademo_CPP.exe barademo_CPP.obj ..\..\..\bin\win64\libbaratinoo.lib /LTCG /OPT:REF /OPT:ICF /MANIFEST /nologo /machine:X64 /pdb:none Ws2_32.lib Iphlpapi.lib Setupapi.lib
...
echo.
echo [4] Move barademo_C.exe in bin\win64\ directory to get the right configuration path and DLL path
move barademo_CPP.exe ..\..\..\bin\win64\
rem copy ..\barademo_CPP.txt ..\..\..\bin\win64\texte.txt
